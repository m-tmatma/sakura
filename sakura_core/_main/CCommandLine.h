...
public:
	...
	ssize_t GetFileNum(void) const noexcept { return static_cast<ssize_t>(m_vFiles.size()); }
	const WCHAR* GetFileName(ssize_t i) const noexcept { return i < GetFileNum() ? m_vFiles[static_cast<size_t>(i)].c_str() : nullptr; }
