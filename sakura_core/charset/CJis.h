...
protected:
	...
	static int _JisToUni_block( const unsigned char* pSrc, const ssize_t nSrcLen, unsigned short* pDst, const EMyJisEscseq eMyJisesc, bool* pbError );
	static int JisToUni( const char* pSrc, const ssize_t nSrcLen, wchar_t* pDst, bool* pbError );
	static int _SjisToJis_char( const unsigned char* pSrc, unsigned char* pDst, ECharSet eCharset, bool* pbError );
	static int UniToJis( const wchar_t* pSrc, const ssize_t nSrcLen, char* pDst, bool* pbError );
