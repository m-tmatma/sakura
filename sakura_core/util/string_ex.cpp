...
CHAR_TYPE* my_strtok(
	...
	ssize_t				nLen,		//[in] 文字列の長さ
	ssize_t*			pnOffset,	//[in,out] オフセット
...
//インスタンス化
template ACHAR* my_strtok(ACHAR*,ssize_t,ssize_t*,const ACHAR*);
template WCHAR* my_strtok(WCHAR*,ssize_t,ssize_t*,const WCHAR*);
