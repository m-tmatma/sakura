...
static int IsNumber( const CStringRef& cStr, ssize_t offset );/* 数値ならその長さを返す */	//@@@ 2001.02.17 by MIK

// -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- //
//                         半角数値                            //
// -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- //

bool CColor_Numeric::BeginColor(const CStringRef& cStr, ssize_t nPos)
{
...
bool CColor_Numeric::EndColor([[maybe_unused]] const CStringRef& cStr, ssize_t nPos)
{
 ...
 */
static int IsNumber(const CStringRef& cStr,/*const wchar_t *buf,*/ ssize_t offset/*, int length*/)
{
	const wchar_t* p;
	const wchar_t* q;
	int i = 0;
