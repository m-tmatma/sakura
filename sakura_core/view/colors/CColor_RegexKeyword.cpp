...
bool CColor_RegexKeyword::BeginColor(const CStringRef& cStr, ssize_t nPos)
{
...
bool CColor_RegexKeyword::EndColor([[maybe_unused]] const CStringRef& cStr, ssize_t nPos)
{
