...
bool CColor_Select::BeginColor([[maybe_unused]] const CStringRef& cStr, [[maybe_unused]] ssize_t nPos)
{
	assert(0);
	return false;
}

bool CColor_Select::BeginColorEx(const CStringRef& cStr, ssize_t nPos, CLayoutInt nLineNum, const CLayout* pcLayout)
{
...
bool CColor_Select::EndColor([[maybe_unused]] const CStringRef& cStr, ssize_t nPos)
{
	//マッチ文字列終了検出
...
bool CColor_Found::BeginColor(const CStringRef& cStr, ssize_t nPos)
{
	if(!cStr.IsValid())return false;
...
bool CColor_Found::EndColor([[maybe_unused]] const CStringRef& cStr, ssize_t nPos)
{
	//マッチ文字列終了検出
