...
bool CColor_LineComment::BeginColor(const CStringRef& cStr, ssize_t nPos)
{
...
bool CColor_LineComment::EndColor(const CStringRef& cStr, ssize_t nPos)
{
	//文字列終端
...
bool CColor_BlockComment::BeginColor(const CStringRef& cStr, ssize_t nPos)
{
	if(!cStr.IsValid())return false;
...
bool CColor_BlockComment::EndColor(const CStringRef& cStr, ssize_t nPos)
{
