...
public:
	...
	*/
	...
	CLayoutXInt GetLayoutXOfChar( const wchar_t* pData, const ssize_t nDataLen, ssize_t i ) const {
	...
	CLayoutXInt GetLayoutXOfChar( const CStringRef& str, ssize_t i ) const {
