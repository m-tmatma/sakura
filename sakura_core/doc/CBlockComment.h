...
public:
	...
	//判定
	bool Match_CommentFrom( ssize_t nPos, const CStringRef& cStr ) const;	//	行コメントに値するか確認する
	ssize_t Match_CommentTo( ssize_t nPos, const CStringRef& cStr ) const;	//	行コメントに値するか確認する
